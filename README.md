...
| [subsequence_lof_multi_sum](./subsequence_lof_multi_sum) | `registry.gitlab.hpi.de/akita/i/subsequence_lof_multi_sum` | python 3.7 | [`registry.gitlab.hpi.de/akita/i/pyod`](./0-base-images/pyod) -> [`registry.gitlab.hpi.de/akita/i/python3-base`](./0-base-images/python3-base) | unsupervised | univariate |
