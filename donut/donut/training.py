...
# patch print function, because somewhere we introduce UTF-8 while assuming ASCII codec
# Fixes error:
...
class DonutTrainer(VarScopeObject):
    ...
    def fit(self, values, labels, missing, mean, std, excludes=None,
            valid_portion=0.3, summary_dir=None, save_callback: Optional[Callable] = None):
        """
