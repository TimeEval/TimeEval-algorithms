...
def get_best_performance_data_sequence(total_err_scores, gt_labels, topk=1):
    total_features = total_err_scores.shape[0]
    ...
    return max(final_topk_fmeas), total_topk_err_scores, pred_labels, thresold, gt_labels
